  ...
  return (
    <section ref={ctaRef} id="contact" className="w-full bg-hc-red text-hc-white py-32 px-6 md:px-12 relative overflow-hidden border-t border-hc-white/10">
      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center text-center cta-content relative z-10">
        ...
        <Link to="/contact" className="btn-magnetic bg-hc-black text-hc-white hover:bg-hc-white hover:text-hc-black px-12 py-6 font-mono font-bold text-lg tracking-widest flex items-center gap-4 transition-colors duration-300 border border-hc-black interactive rounded-full">
